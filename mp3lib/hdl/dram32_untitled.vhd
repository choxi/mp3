...
PORT( 
	...
	DATAIN   : IN     LC3B_DWORD;
	MREAD_L  : IN     STD_LOGIC;
	MWRITE_L : IN     STD_LOGIC;
	RESET_L  : IN     STD_LOGIC;
	DATAOUT  : OUT    LC3B_DWORD;
		...
		ELSE
			IF ((INT_ADDRESS >= 0) AND (INT_ADDRESS <= 65535)) THEN
				...
				IF (MREAD_L = '0' AND MWRITE_L = '1') THEN
					DATAOUT(7 DOWNTO 0) <= MEM(INT_ADDRESS) AFTER DELAY_32B_MEM;
					DATAOUT(15 DOWNTO 8) <= MEM(INT_ADDRESS + 1) AFTER DELAY_32B_MEM;
					DATAOUT(23 DOWNTO 16) <= MEM(INT_ADDRESS + 2) AFTER DELAY_32B_MEM;
					DATAOUT(31 DOWNTO 24) <= MEM(INT_ADDRESS + 3) AFTER DELAY_32B_MEM;
					MRESP_H <= '1' AFTER DELAY_32B_MEM, '0' AFTER DELAY_32B_MEM + CLOCK_PERIOD;
