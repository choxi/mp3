echo "--- Executing initialization force file for indirect.vhd ---"
...
echo "Done initializing processor, loading indirect.vhd program code."
...
change /mp3_cpu/memory/DRAM/vhdl_memory/mem(10) X"45"
change /mp3_cpu/memory/DRAM/vhdl_memory/mem(11) X"1B"
change /mp3_cpu/memory/DRAM/vhdl_memory/mem(12) X"CB"
change /mp3_cpu/memory/DRAM/vhdl_memory/mem(13) X"B3"
change /mp3_cpu/memory/DRAM/vhdl_memory/mem(14) X"CB"
change /mp3_cpu/memory/DRAM/vhdl_memory/mem(15) X"A5"
...
change /mp3_cpu/memory/DRAM/vhdl_memory/mem(22) X"26"
...
run 5
echo "Done loading indirect.vhd program code."
