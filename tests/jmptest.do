echo "--- Executing initialization force file for jmptest.vhd ---"
...
echo "Done initializing processor, loading jmptest.vhd program code."
...
change /mp3_cpu/memory/DRAM/vhdl_memory/mem(3) X"C0"
...
run 5
echo "Done loading jmptest.vhd program code."
