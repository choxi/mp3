echo "--- Executing initialization force file for lea.vhd ---"
...
echo "Done initializing processor, loading lea.vhd program code."
...
change /mp3_cpu/memory/DRAM/vhdl_memory/mem(10) X"06"
change /mp3_cpu/memory/DRAM/vhdl_memory/mem(11) X"E0"
...
change /mp3_cpu/memory/DRAM/vhdl_memory/mem(24) X"32"
...
run 5
echo "Done loading lea.vhd program code."
