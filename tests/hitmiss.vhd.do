echo "--- Executing initialization force file for hitmiss.vhd ---"
...
echo "Done initializing processor, loading hitmiss.vhd program code."
...
run 5
echo "Done loading hitmiss.vhd program code."
