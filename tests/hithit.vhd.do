echo "--- Executing initialization force file for hithit.vhd ---"
...
echo "Done initializing processor, loading hithit.vhd program code."
...
change /mp3_cpu/memory/DRAM/vhdl_memory/mem(5) X"6A"
...
change /mp3_cpu/memory/DRAM/vhdl_memory/mem(20) X"1E"
change /mp3_cpu/memory/DRAM/vhdl_memory/mem(21) X"00"
change /mp3_cpu/memory/DRAM/vhdl_memory/mem(22) X"EF"
change /mp3_cpu/memory/DRAM/vhdl_memory/mem(23) X"BE"
...
change /mp3_cpu/memory/DRAM/vhdl_memory/mem(30) X"0D"
change /mp3_cpu/memory/DRAM/vhdl_memory/mem(31) X"60"
change /mp3_cpu/memory/DRAM/vhdl_memory/mem(32) X"DD"
change /mp3_cpu/memory/DRAM/vhdl_memory/mem(33) X"B4"
...
run 5
echo "Done loading hithit.vhd program code."
