echo "--- Executing initialization force file for misshit.vhd ---"
...
echo "Done initializing processor, loading misshit.vhd program code."
...
run 5
echo "Done loading misshit.vhd program code."
