...
-- DATAPATH SIGNAL WIDTHS
	...
	SUBTYPE LC3B_CINDEX IS STD_LOGIC_VECTOR(2 DOWNTO 0);
	SUBTYPE LC3B_COFFSET IS STD_LOGIC_VECTOR(3 DOWNTO 0);
	SUBTYPE LC3B_NZP IS STD_LOGIC_VECTOR(2 DOWNTO 0);
	SUBTYPE LC3B_24  IS STD_LOGIC_VECTOR(23 DOWNTO 0);
	...
	CONSTANT DELAY_COMPARE : TIME := 5 NS;
	CONSTANT DELAY_DECODE : TIME := 2 NS;
	CONSTANT DELAY_ENCODE8 : TIME := 2 NS;
